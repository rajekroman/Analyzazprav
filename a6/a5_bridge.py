...
def run_local_a5(
    ...
    *,
    ...
    """Run A5 explicitly through a local Ollama provider when A5 is installed.

    This import is intentionally lazy so A6 remains usable while the A5 branch
    is not yet integrated. No network/cloud fallback is attempted.
    """
