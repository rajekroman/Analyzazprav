...
def main() -> int:
    ...
    parser.add_argument("--a4-result", default="success")
    ...
    reports = {
        ...
        "A4": _read(root / "a7-a4-report.json"),
    ...
    report["scope"] = (
        "synthetic exact-head downstream contract; not a claim that an arbitrary real user archive "
        "or source-specific Apple schema has been validated"
    )
