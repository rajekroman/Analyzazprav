...
class AnalysisContext:
    ...
    def prompt_payload(self) -> dict[str, Any]:
        return {
            ...
            "messages": [m.safe_payload() for m in self.messages],
        }
...
class MetricEvidence:
    """Reference to a deterministic metric supplied by A4/context builder."""
...
class AIAnalysisResult:
    # Existing presentation fields stay text-compatible with A6. Every
    # assertion-bearing synthesis field has a parallel validated evidence ref.
    summary: str
